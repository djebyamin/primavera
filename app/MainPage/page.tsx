      ...
      <header className="bg-white shadow-sm">
        ...
        <nav className="container mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <a href="#" className="text-gray-700 hover:text-gray-900">Cours</a>
            <a href="#" className="text-gray-700 hover:text-gray-900">Formations</a>
            <a href="#" className="text-gray-700 hover:text-gray-900">Contact</a>
            <a href="#" className="text-gray-700 hover:text-gray-900">À propos</a>
            <a href="#" className="text-gray-700 hover:text-gray-900">Devenir formateur</a>
            <a href="#" className="text-gray-700 hover:text-gray-900">Devenir partenaire</a>
          </div>
          <div className="flex items-center space-x-4">
        ...
        <div className="container mx-auto px-4 py-2 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <div className="relative">
              <input type="text" placeholder="Project management" className="pl-8 pr-2 py-1 border rounded-full" />
            ...
            <button className="bg-red-500 text-white px-4 py-1 rounded-full text-sm">Commencez</button>
          </div>
        </div>
      </header>
